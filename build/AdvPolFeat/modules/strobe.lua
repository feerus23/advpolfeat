...
local function tbl_add(tbl, pos, val)
	if tbl ~= nil then
		if tbl[pos] == nil then
...
local function ti2t(tbl1, tbl2, name)
...
--[[
local function es_strobe(v_id, c_id)
	local ei = _es_init
	for i = 1, #ei do
